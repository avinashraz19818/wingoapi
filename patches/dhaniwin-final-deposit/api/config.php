...
return [
    ...
    'db' => [
        'driver' => getenv('DHANI_DB_DRIVER') ?: 'mysql',
        ...
        'mysql' => [
            ...
            'database' => getenv('DHANI_DB_NAME') ?: 'club532583_dhsuraj',
            'username' => getenv('DHANI_DB_USER') ?: 'club532583_dhsuraj',
            'password' => getenv('DHANI_DB_PASS') ?: 'club532583_dhsuraj',
        ],
    ],
    'admin' => [
